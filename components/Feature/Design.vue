<template>
  <LayoutSideBySide :reversed="true">
    <template #text-pane>
      ...
      <p>
        Unlike some of our music, we’re not living in the 90s anymore.
        Koel’s design is clean, modern, and simply gorgeous.
        With an interface inspired by the most popular music players out there, you’ll feel right at home.
    ...
    <template #media-pane>
      <WithBacklight :color="'rgb(0, 208, 227)'">
        <WithGradientBorder class="rounded-lg sm:rounded-xl">
          <div class="flex relative -space-x-[100%]">
            <img
              ...
              :src="theme.src"
              class="theme drop-shadow-md rounded-lg sm:rounded-xl shadow-lg border border-pink-500/30 transition-[clip-path] motion-reduce:transition-none duration-500"
            />
          </div>
        </WithGradientBorder>
      </WithBacklight>
